...
| L18 | Couverture des gestes par les tests : unitaires pour la logique, un parcours e2e pour les gestes | 2 | à faire | `phase-2/L18-couverture-des-gestes.md` |
...
- **Tests** : 71 tests après L15, sur une vraie base Isar temporaire ; chaque lot ajoute les
  ...
  L18 ; aucun geste d'interface n'a de test de widget aujourd'hui.
