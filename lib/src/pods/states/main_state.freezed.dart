...
mixin _$MainState {
 ...
 int? get selectedEventId; int? get selectedSessionId; int? get selectedPlayerGroupId;
...
@useResult
$Res call({
 int? selectedEventId, int? selectedSessionId, int? selectedPlayerGroupId
});
...
/// Create a copy of MainState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedEventId = freezed,Object? selectedSessionId = freezed,Object? selectedPlayerGroupId = freezed,}) {
  return _then(_self.copyWith(
selectedEventId: freezed == selectedEventId ? _self.selectedEventId : selectedEventId // ignore: cast_nullable_to_non_nullable
as int?,selectedSessionId: freezed == selectedSessionId ? _self.selectedSessionId : selectedSessionId // ignore: cast_nullable_to_non_nullable
as int?,selectedPlayerGroupId: freezed == selectedPlayerGroupId ? _self.selectedPlayerGroupId : selectedPlayerGroupId // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? selectedEventId,  int? selectedSessionId,  int? selectedPlayerGroupId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MainState() when $default != null:
return $default(_that.selectedEventId,_that.selectedSessionId,_that.selectedPlayerGroupId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? selectedEventId,  int? selectedSessionId,  int? selectedPlayerGroupId)  $default,) {final _that = this;
switch (_that) {
case _MainState():
return $default(_that.selectedEventId,_that.selectedSessionId,_that.selectedPlayerGroupId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? selectedEventId,  int? selectedSessionId,  int? selectedPlayerGroupId)?  $default,) {final _that = this;
switch (_that) {
case _MainState() when $default != null:
return $default(_that.selectedEventId,_that.selectedSessionId,_that.selectedPlayerGroupId);case _:
  return null;
...
class _MainState extends MainState {
  const _MainState({this.selectedEventId, this.selectedSessionId, this.selectedPlayerGroupId}): super._();
  

@override final  int? selectedEventId;
@override final  int? selectedSessionId;
@override final  int? selectedPlayerGroupId;
...
/// Create a copy of MainState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedEventId = freezed,Object? selectedSessionId = freezed,Object? selectedPlayerGroupId = freezed,}) {
