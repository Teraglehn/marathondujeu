...
class IconService {
  ...
  static Iterable<MapEntry<String, IconData>> _getSharpIconsFrom(Iterable<MapEntry<String, IconData>> icons) {
    return icons.where((e) => e.key.endsWith("_sharp"));
  }

  static Iterable<MapEntry<String, IconData>> _getRoundedIconsFrom(Iterable<MapEntry<String, IconData>> icons) {
    return icons.where((e) => e.key.endsWith("_rounded"));
  }

  static Iterable<MapEntry<String, IconData>> _getOutlinedIconsFrom(Iterable<MapEntry<String, IconData>> icons) {
    return icons.where((e) => e.key.endsWith("_outlined"));
  }

  static Iterable<MapEntry<String, IconData>> _getRegularIconsFrom(Iterable<MapEntry<String, IconData>> icons) {
    return icons.where((e) => !e.key.endsWith("_outlined") && !e.key.endsWith("_rounded") && !e.key.endsWith("_sharp"));
  }

  static Iterable<MapEntry<String, IconData>> _getIconsByCategoryFrom(Iterable<MapEntry<String, IconData>> icons, IconCategory category) {
    switch (category) {
      case IconCategory.sharp:
        return _getSharpIconsFrom(icons);
      case IconCategory.rounded:
        return _getRoundedIconsFrom(icons);
      case IconCategory.outlined:
        return _getOutlinedIconsFrom(icons);
      case IconCategory.filled:
        return _getRegularIconsFrom(icons);
    }
  }

  static Iterable<MapEntry<String, IconData>> _searchIconsFrom(Iterable<MapEntry<String, IconData>> icons, String text) {
    return icons.where((e) => e.key.replaceAll("_", " ").contains(text) || e.key.contains(text));
  }

  static Iterable<IconData> _getIconsFrom(Iterable<MapEntry<String, IconData>> icons) {
    return icons.map((e) => e.value);
  }
  ...
  static Iterable<IconData> getSharpIcons() {
    return _getIconsFrom(_getSharpIconsFrom(_icons.entries));
  }

  static Iterable<IconData> getRoundedIcons() {
    return _getIconsFrom(_getRoundedIconsFrom(_icons.entries));
  }

  static Iterable<IconData> getOutlinedIcons() {
    return _getIconsFrom(_getOutlinedIconsFrom(_icons.entries));
  }

  static Iterable<IconData> getRegularIcons() {
    return _getIconsFrom(_getRegularIconsFrom(_icons.entries));
  }

  static Iterable<IconData> getIconsByCategory(IconCategory category) {
    return _getIconsFrom(_getIconsByCategoryFrom(_icons.entries, category));
  }

  static Iterable<IconData> searchIcons(String text) {
    return _getIconsFrom(_searchIconsFrom(_icons.entries, text));
  }

  static Iterable<IconData> searchIconsByCategory(String text, IconCategory category) {
    if(text.isEmpty){
      return getIconsByCategory(category);
    }
    return _getIconsFrom(_searchIconsFrom(_getIconsByCategoryFrom(_icons.entries, category), text));
  }
