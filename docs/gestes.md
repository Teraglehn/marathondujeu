...
| **EV-8** Cocher *Générer les sessions (supprime les sessions existantes)* puis *Enregistrer* | sessions existantes ou non ; **des badgeages existent** ou non | les sessions sont recréées de début à fin, une toutes les *intervalle* minutes, longues de *durée* ; les badgeages des anciennes sont perdus. Des badgeages existent → **confirmation** d'abord, « Les sessions seront recréées et n badgeages perdus » ; *Annuler* laisse tout en place, l'éditeur reste ouvert | service (`countBadges`) |
